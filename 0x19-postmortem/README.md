Postmortem
Upon the release of ALX's System Engineering & DevOps project 0x19, approximately 06:00 Central African Time (CAT) here in Rwanda, an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an HTML file defining a simple Holberton WordPress site.
...
But of course, it will never occur again, because we're programmers, and we learn from our previous mistakes!
